                    ...
                    <div class="card-body p-3">
                        ...
                        <div class="form-group">
                            <div class="input-group mb-2">
                                ...
                                <?php
                                echo'<input type="text" class="form-control" id="name" name="name" value="'.$_POST['name'].'" placeholder="Podaj imię.." required>'
                                ?>
                            </div>
                            <div class="form-group">
                                <div class="input-group mb-2">
                                    ...
                                    <?php
                                    echo '<input type="text" class="form-control" id="last-name" name="last-name" value="'.$_POST['name'].'" placeholder="Podaj nazwisko.." required>'
                                    ?>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group mb-2">
                                    ...
                                    <?php
                                    echo'<input type="email" class="form-control" id="email" name="email" value="'.$_POST['mail'].'" placeholder="przykład@emial.com" required>'
                                    ?>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="input-group mb-2">
                                    <div class="input-group-prepend">
                                        <label>
                                            <?php
                                            echo '<input type="file" name="image" accept="image/jpeg,image.png">'
                                            ?>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="input-group mb-2">
                                    ...
                                    <?php
                                    echo '<textarea class="form-control" name="comment" placeholder="Wpisz komentarz..">'.$_POST['comment'].'</textarea>'
                                    ?>
                                </div>
                            </div>
...
// Walidacja danych
    ...
    if ((empty($name)) || (strlen($name) > 15) || (ctype_alpha($name) == false)) {
    ...
    if ((empty($surname)) || (strlen($surname) > 15) || (ctype_alpha($surname) == false)) {
        echo '  <div class="row"><section class="col-lg-4 col-sm-2 col-md-2"></section>
                <section class="col-lg-4 col-sm-8 col-md-8" ><div class="alert alert-danger" >
    ...
    if ((empty($mail)) || (!preg_match($check, $mail) == 1)) {
        echo '  <div class="row"><section class="col-lg-4 col-sm-2 col-md-2"></section>
                <section class="col-lg-4 col-sm-8 col-md-8"><div class="alert alert-danger">
    ...
    if ($ext == "jpg" || $ext == "pjpeg" || $ext == "jpeg" || $ext == "gif" || $ext == "png") {
        ...
        $data_upload = date("myds");

        if (is_uploaded_file($plik_tmp)) {
            move_uploaded_file($plik_tmp, './upload' . $save_file . '');
            ...
            imagejpeg($img_mini, "min-" . $save_file . $data_upload . "", 80);
            imagedestroy($img);
    ...
    if ($allRight == true) {
        //Wszystko okej, dodajemy do bazy
